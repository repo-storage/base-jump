    ...
    <?php else : ?>
        <div class="entry-content">
            ...
            <div class="theme-thumbnail">
                <a href="<?php the_permalink(); ?>" title="<?php printf(esc_attr__('Permalink to %s', 'basejump'), the_title_attribute('echo=0')); ?>" rel="bookmark"><?php the_post_thumbnail('themes-thumbnail'); ?>
                </a>
    </div>

            <?php else : ?>
            <div class="theme-thumbnail theme-dev-images">
                    THUMBNAIL PREVIEW
                    <!-- class content -->
                </div>
                <!-- ###### -->
