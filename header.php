...
<!--        <link rel="stylesheet" type="text/css" media="all" href="<?php echo get_template_directory_uri().'/library/css/wp.css' ?>" />-->
        ...
        <link rel="stylesheet" href="<?php echo cwp::locate_in_library('foundation.css', 'foundation/stylesheets'); ?>">
        ...
        <link rel="stylesheet" href="<?php echo cwp::locate_in_library('stylesheet.css', 'fonts/pictograms'); ?>">
        <link rel="stylesheet" href="<?php echo cwp::locate_in_library('stylesheet.css', 'fonts/socialico-web'); ?>">
